#!/bin/bash
#SBATCH --job-name=Training_oldmodel
#SBATCH --mail-type=BEGIN,END
#SBATCH --mail-user=d.koopmans@sron.nl
#SBATCH --output=/home/dkoopmans/SPIRE-SR-AI/logs/UnetResnet34Tr/Training-oldmodel-job-%j.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
CONFIG_FILE="TrainConfig_oldmodel.yaml"
...
# Run training script
python "/home/dkoopmans/SPIRE-SR-AI/scripts/train/train_with_old_loss.py" --config "${CONFIG_DIR}"