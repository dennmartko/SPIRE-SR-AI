...
from loss_functions import old_non_adversarial_loss
...
def train_step(x, y, masks, alpha, model, optimizer):
    with tf.GradientTape() as tape:
        ...
        train_loss = old_non_adversarial_loss(predictions, y, masks, alpha)
...
for epoch in tqdm(epochs, desc="Training model..."):
    ...
    for batch_x, batch_y in val_ds:
        ...
        val_loss = old_non_adversarial_loss(predictions, batch_y[:, :, :, :n_targets], batch_y[:, :, :, n_targets:], alpha)
